...
public static class Registration
{
  ...
  public static void ObjectsInitialisation(Registry registry)
  {
    ...
    Objects.Auth_Login_PasswordInput = registry.RegisterObject("PasswordInput", ["Auth/Login"], [1], new PasswordInput(new Vector2(600, 100), new Vector2(500, 50), 3, 24, Materials.Global_Font, "Encrypt Key here (if needed)"));
